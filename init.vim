...
autocmd BufWritePre *.go :silent! execute 'CocCommand editor.action.formatDocument'

"Configuracion de diffview
lua << EOF
...
" Goland
nnoremap <Leader>gor :vsplit<CR>:terminal go run %<CR>
"
inoremap jk <ESC>
inoremap <C-C> <ESC>
...
let g:python3_host_prog = 'C:\Users\72720804\AppData\Local\Python\pythoncore-3.14-64\python.exe'
